class Profile < ApplicationRecord
  ...
  RESOURCES = [
    ...
    { key: "field_checkins",     label: "Check-ins em campo",     icon: "bi-geo-fill",         actions: %w[view manage],       scopeable: false, description: "Monitorar check-ins de corretores" },
    { key: "field_manual",       label: "Pedidos manuais",        icon: "bi-hand-index-thumb", actions: %w[view manage],       scopeable: false, description: "Aprovar check-ins manuais" },
    { key: "field_audit",        label: "Auditoria field",        icon: "bi-shield-lock",      actions: %w[view],              scopeable: false, description: "Trilha append-only de check-ins" },
    { key: "field_settings",     label: "Configurações field",    icon: "bi-toggles2",         actions: %w[manage],            scopeable: false, description: "Liga/desliga feature de check-in" },
