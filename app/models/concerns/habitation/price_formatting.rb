module Habitation::PriceFormatting
  ...
  included do
    %w[valor_venda valor_locacao valor_locacao_anterior valor_condominio valor_iptu valor_promocional valor_por_m2 valor_venda_anterior valor_aceito_permuta permuta_valor saldo_devedor].each do |field|
